...
CREATE TABLE `school_info` (
  ...
  `class_available` int DEFAULT NULL,
  ...
  CONSTRAINT `fk_school_info_principal1` FOREIGN KEY (`principal_id`) REFERENCES `principal` (`principal_id`)
...
INSERT INTO `school_info` VALUES ('Habib School','Pehlwan Goth',5,'0334-2139367','elementary','75951',3);
