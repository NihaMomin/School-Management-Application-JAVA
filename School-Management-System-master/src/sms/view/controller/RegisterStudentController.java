...
public class RegisterStudentController implements Initializable {
    ...
    private void AddStudent(ActionEvent event) {
        try {
            ...
            if (v.validateEmpty(adNoField) && v.validateEmpty(dobField) && v.validateEmpty(doaField) &&  v.validateEmpty(emailField) &&
                    v.validateEmpty(phoneField) && v.validateEmpty(nicField) && v.numbersOnly(adNoField)
                    && v.validateEmpty(phoneField) && v.validateDate(doaField) && v.validateDate(dobField)) {
